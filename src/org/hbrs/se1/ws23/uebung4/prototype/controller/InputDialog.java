  ...
  public void startEingabe() throws ContainerException, Exception {
    ...
    while (true) {
      ...
      if (strings[0].equals("help")) {
        System.out.println("Folgende Befehle stehen zur Verfuegung: help, dump, enter, exit, store, search 'project', load, dump projekt 'project'");
        continue;
      }
      ...
      if (strings[0].equals("enter")) {
        ...
        while (Util.getUserStory(id) != null) {
